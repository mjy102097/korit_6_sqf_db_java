...
public class DVDDao {
    public static int addDvd(DVD dvd) {
        ...
        try {
            ...
            String sql = "insert into dvd_tb values(0, ?, ?, ?, ?, ?, now())"; // ? 는 어떤게 들어올지 모른다 라는 뜻.
            preparedStatement = connection.prepareStatement(sql);
            preparedStatement.setString(1, dvd.getRegistrationNumber()); // ? 는 0번부터 시작이 아니라 1번부터 시작
            ...
            preparedStatement.setInt(5, dvd.getPublisherYear());
    ...
    public static int addProducer(Producer producer) {
        ...
        try {
            ...
            successCount = preparedStatement.executeUpdate();   // 퀴리 실행
        ...
        try {
            ...
            while(resultSet.next()) {
                ...
                DVD dvd = DVD.builder()
                        ...
                        .publisher(publisher)
                        .publisherYear(resultSet.getInt(8))
